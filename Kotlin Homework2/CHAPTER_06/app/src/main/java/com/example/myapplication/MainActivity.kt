    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_dialog1.setOnClickListener {
                AlertDialog.Builder(this)
                    ...
                    .setNeutralButton("左按鈕"){ dialog,wich ->
                        showToast("左按鈕")
                    }
                    .setNegativeButton("中按鈕"){ dialog,wich ->
                        showToast("中按鈕")
                    }
                    .setPositiveButton("右按鈕"){ dialog,wich ->
                        showToast("右按鈕")
                    }.show()
        }
        ...
        btn_dialog3.setOnClickListener {
                var position = 0
                AlertDialog.Builder(this)
                    .setTitle("選單式AlertDialog")
                    .setSingleChoiceItems(item,0) { dialogInterface, i ->
                        position = i}
                    .setPositiveButton("確定"){ dialog,witch ->
